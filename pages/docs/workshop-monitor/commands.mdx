---
title: Commands | Workshop Monitor
...
export const getStaticProps = ({ params }) => {
  return fetch(`${process.env.NEXT_PUBLIC_WORKSHOP_NOTIFIER_API_URL}/api/commands`)
    .then((res) => res.json())
    .then(data => ({
      props: {
...
export const WorkshopNotifierCommandAccordion = () => {
...
<WorkshopNotifierCommandAccordion />
