...
<Callout type="info">This is not the permission level required to execute actions or run commands, like User, Moderator or Administrator - those are [Client Permissions](/docs/cftools-discord-bot/client-permissions)</Callout>
