...
<Callout type="info">You need this if you want to use/display `/statistics` hit-zone heat-maps - can be ommitted through the [configuration file](/docs/cftools-discord-bot/2-configuration)</Callout>
