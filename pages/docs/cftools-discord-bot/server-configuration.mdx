...
<Callout type="info">Check out [our guide](/docs/gameshield-getting-started) if you need help setting up your CFTools webhook - it's made for a different project, but the process is the same</Callout>
...
2. Change `KILL_FEED_REMOVE_IDENTIFIER` to `true`
