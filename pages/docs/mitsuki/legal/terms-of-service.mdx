---
searchable: false
title: Terms of Service | Mitsuki
...
Please read the Terms of Service carefully/thoroughly. By using the **Mitsuki** bot you agree to these terms of service.

The **Mitsuki** [Discord](https://discord.com) bot, further referred to as "the service", "the bot" or "Mitsuki", is meant to enhance the Discord member experience by providing a full-fledged, and customizable leveling system. To ensure that we can deliver the best possible experience, and to prevent malicious actors from abusing the services **Mitsuki** offers, we've established the following terms of service:

## Rules of Conduct

When using **Mitsuki**, you must follow the rules (as presented below this paragraph) in order to keep both our users (you) and the services **Mitsuki** uses (currently only [The Discord API](https://discord.dev)) safe. In order to achieve this, we (**Mitsuki** and it's developers) reserve the right to prevent users from further using the entire service, or parts of the service.
